...
const Banner = ({
  ...
  return (
    <Card
      className={`relative overflow-hidden p-8 flex-1 bg-gradient-to-r from-${gradientFrom} to-${gradientTo}/50 border-none transition-all duration-300 hover:shadow-lg`}
    >
